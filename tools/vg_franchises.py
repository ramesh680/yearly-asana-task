"""Video Game Franchises section."""
from __future__ import annotations
import csv, io
from . import vg_franchises_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Video Game Franchises", "edition": DATA.VGFRAN_EDITION, "url": DATA.VGFRAN_SOURCE_URL, "note": "Major video game franchises with their publisher."}
...
def columns():
    cols = [("Rank", "rank")] + [('Franchise', 'franchise'), ('Publisher', 'publisher')] + [("Website", "website")]
