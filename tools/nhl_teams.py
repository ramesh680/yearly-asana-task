"""National Hockey League section."""
from __future__ import annotations
import csv, io
from . import nhl_teams_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "National Hockey League", "edition": DATA.NHL_EDITION, "url": DATA.NHL_SOURCE_URL, "note": "All 32 NHL teams by conference and division."}
