...
import csv, io
from . import serie_a_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Serie A", "edition": DATA.SERIEA_EDITION, "url": DATA.SERIEA_SOURCE_URL, "note": "Serie A clubs (2025-26 season)."}
