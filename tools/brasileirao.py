"""Brasileirão Série A section."""
from __future__ import annotations
import csv, io
from . import brasileirao_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Brasileirão Série A", "edition": DATA.BRASILEIRAO_EDITION, "url": DATA.BRASILEIRAO_SOURCE_URL, "note": "Campeonato Brasileiro Série A clubs (2025 season)."}
...
def get_rows(live: bool = False):
    rows = []
    for r in DATA.BRASILEIRAO_CLUBS:
