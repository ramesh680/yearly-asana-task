...
import csv, io
from . import streaming_services_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Streaming Services", "edition": DATA.STREAMING_EDITION, "url": DATA.STREAMING_SOURCE_URL, "note": "Notable streaming media services (video, music, live, audio)."}
...
def columns():
    cols = [("Rank", "rank")] + [('Service', 'service'), ('Type', 'type')] + [("Website", "website")]
