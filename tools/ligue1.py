...
import csv, io
from . import ligue1_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Ligue 1", "edition": DATA.LIGUE1_EDITION, "url": DATA.LIGUE1_SOURCE_URL, "note": "Ligue 1 clubs (2025-26 season)."}
