"""National Women's Soccer League section."""
from __future__ import annotations
import csv, io
from . import nwsl_teams_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "National Women's Soccer League", "edition": DATA.NWSL_EDITION, "url": DATA.NWSL_SOURCE_URL, "note": "NWSL clubs with home city and stadium."}
