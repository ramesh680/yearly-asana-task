...
import csv, io
from . import sporting_events_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Sporting Events", "edition": DATA.EVENTS_EDITION, "url": DATA.EVENTS_SOURCE_URL, "note": "The biggest global sporting events, ranked by popularity."}
...
def columns():
    cols = [("Rank", "rank")] + [('Event', 'event'), ('Sport', 'sport')] + [("Website", "website")]
