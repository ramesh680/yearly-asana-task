...
import csv, io
from . import laliga_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "LaLiga", "edition": DATA.LALIGA_EDITION, "url": DATA.LALIGA_SOURCE_URL, "note": "LaLiga clubs (2025-26 season)."}
