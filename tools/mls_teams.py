"""Major League Soccer section."""
from __future__ import annotations
import csv, io
from . import mls_teams_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Major League Soccer", "edition": DATA.MLS_EDITION, "url": DATA.MLS_SOURCE_URL, "note": "All 30 MLS clubs by conference."}
...
def columns():
    cols = [("Rank", "rank")] + [('Club', 'team'), ('Conf', 'conference'), ('City', 'city'), ('Stadium', 'stadium')] + [("Website", "website")]
