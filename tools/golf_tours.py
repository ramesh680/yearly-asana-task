...
import csv, io
from . import golf_tours_data as DATA
from . import socials

SOCIAL_FIELDS = socials.SOCIAL_FIELDS
INFO = {"label": "Golf Tours", "edition": DATA.GOLF_EDITION, "url": DATA.GOLF_SOURCE_URL, "note": "Major professional golf tours and circuits."}
...
def columns():
    cols = [("Rank", "rank")] + [('Tour', 'tour'), ('Region', 'region')] + [("Website", "website")]
